...
CURRENT_TRUTH_ROWS = {
    ...
    "Canonical Write Canary Freshness": "write_canary_freshness",
    "Canonical Cloudflare Capability Check": "cloudflare_capability_check",
    "Canonical Cloudflare Permission Status": "cloudflare_permission_status",
    "Canonical LOW_LIVE Readiness": "low_live_readiness",
    "Canonical LOW_LIVE Promotion Gate": "low_live_promotion_gate_status",
...
def observed_from_master(master: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "write_canary_status": header.get("write_canary_status"),
        "write_canary_freshness": header.get("write_canary_freshness"),
        "cloudflare_capability_check": header.get("cloudflare_capability_check"),
        "cloudflare_permission_status": header.get("cloudflare_permission_status"),
        "low_live_readiness": header.get("low_live_readiness"),
        "low_live_promotion_gate_status": header.get("low_live_promotion_gate_status"),
...
def observed_from_pipeline(pipeline: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "write_canary_status": runtime.get("write_canary_status"),
        "write_canary_freshness": runtime.get("write_canary_freshness"),
        "cloudflare_capability_check": runtime.get("cloudflare_capability_check"),
        "cloudflare_permission_status": runtime.get("cloudflare_permission_status"),
        "low_live_readiness": runtime.get("low_live_readiness"),
        "low_live_promotion_gate_status": runtime.get("low_live_promotion_gate_status"),
...
def _canonical_fixture(**overrides: Any) -> Dict[str, Any]:
    base = {
        ...
        "write_canary_freshness": "CURRENT",
        "cloudflare_capability_check": "CLOUDFLARE_WRITE_CAPABILITY_PERMISSION_UNPROVEN",
        "cloudflare_permission_status": "ZONE_WAF_WRITE_PERMISSION_UNPROVEN",
        "low_live_readiness": "NOT_READY_FOR_OWNER_ACTIVATION",
        "low_live_promotion_gate_status": "RUNTIME_PROMOTION_BLOCKED_BY_WRITE_READINESS",
